...
export default {
    ...
    categoryTitle: {color: Color.grayClg, fontSize:FS(3.5), fontWeight: 'bold'},
  ...
  formView: [
	...
	userDetailsView: {width: Util.getWidth(64), padding: Util.getWidth(1), justifyContent: "center"},
	btnView: {marginTop: Util.getHeight(2), marginBottom: Util.getHeight(3),justifyContent: "center",alignItems: 'center',},
};
