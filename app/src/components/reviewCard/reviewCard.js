  ...
  render() {
    return (
      <View
        ...
        style={[
          Styles.cardArea,
          this.props.btn == undefined ? {} : { height: Util.getHeight(40) }
        ]}
      >
        <View
          style={{
        ...
        >
          ...
          <View style={Styles.timeView}>
            <Text style={[Styles.timeTextDesign, { alignSelf: "flex-end" }]}>
              {"{" +
                (this.props.item.cdate !== undefined
                  ? this.props.item.cdate
                  : "25/04/2019") +
                "}"}
            </Text>
          </View>
        ...
        <View
          style={{
            height: this.props.btn == undefined ? "37%" : "27%",
            marginTop: "3%",
            width: "100%",
            flexDirection: "row"
          }}
        ...
        <View
          style={{
            height: this.props.btn == undefined ? "30%" : "25%",
            width: "100%",
            justifyContent: "center"
          }}
        >
          ...
          >
            <Text
              style={[Styles.timeText, { color: Color.grayClg, flex: 1.6 }]}
            >
              Was the intructor on time
            </Text>
            <Text style={Styles.timeText}>
              {this.props.item.iot === 1 ? "YES" : "NO"}
            </Text>
          </View>
          <View
            style={{
          ...
          >
            <Text
              style={[Styles.timeText, { color: Color.grayClg, flex: 1.6 }]}
            >
              Was the instructor Profeesional
            </Text>
            <Text style={Styles.timeText}>
              {this.props.item.isp === 1 ? "YES" : "NO"}
            </Text>
          </View>
          <View
            style={{
